...
PROP RULE (CRITICAL):
Each character has THEIR OWN look. PROPS ARE PERSONAL — they belong to ONE character at a time. NEVER copy one character's signature prop onto another. Kevin (and Kevin ONLY) wears the calculator-helmet. Benny (and Benny ONLY) rides the forklift in his orange vest. Mark Rober is a normal Earth man — earnest, polo shirt, no fantasy props. Scarlet is the red dragon. All other students and adults are ORDINARY-LOOKING kids and grown-ups with naturalistic features — varied skin tones, regular clothes, regular hair, NO calculator helmets on extras, NO gas masks on extras. The humor comes from what's HAPPENING in the scene, not from giving every character a strange prop.
...
Skin tones rotate: deep brown / warm brown / golden / olive / freckled cream. White is the LAST option, not the first.`,
        references: `STYLE REFERENCE: Warm classroom-comedy register — Lauren Child, Oliver Jeffers, Captain Underpants panels but more grounded. Real classroom with real kids who actually look like kids, plus ONE absurd thing happening in the scene (a beaver on a forklift, a kid on a scooter with a rocket). The absurdity lives in WHAT HAPPENS, not in every face. Cream paper. Black ink. Flat color. Real kids. One weird thing.`,
        dontList: `DO NOT: painterly brushwork, watercolor texture, photorealism, manga/anime, gradients, glow effects, lens flares, text/labels/captions/signs visible in the image, calculator-helmet on anyone but Kevin, gas mask on anyone but Benny, comic panel layouts, speech bubbles, thought bubbles, multi-beat collages. NEVER default to white skin. NEVER give every character an absurd prop — most characters are just normal kids and grown-ups with normal looks.`,
        paper: `Plain warm cream / off-white paper (#F4ECD8). Scenes can have classroom backgrounds, props, and other kids when they're part of the story.`,
      },
    },
    'burgundy': {
      slug: 'burgundy',
