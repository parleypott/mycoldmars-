// Verifier-layer test for the Switzerland PWA map's bounds builders.
//
// TWIN-LOCK: journeyCoords/entryBounds/fitAll here are BYTE-IDENTICAL to the Lauterbrunnen
// copy (public/lauterbrunnen/journey-bounds.test.mjs). That copy was locked; this live twin
// — the actively-edited Switzerland trip map — was not. Same code, same crash class, no guard.
//
...
assert.ok(JOURNEYS.length >= 5, 'expected the curated Switzerland journeys');
